...
export const aboutData = {
  img: 'profile.jpg',
  paragraphOne:
    'Software Engineer that specializing in both frontend and -heavily- backend development. Well-versed with nearly all stages of the development cycle for dynamic web projects. Experienced in numerous programming languages and frameworks including Java, Spring Boot, JavaScript, React, Node, Express, Scala, Python, MySQL, PostgreSQL, MongoDB, Redis, Kafka. Have a good background in Computer Science.',
  paragraphTwo:
