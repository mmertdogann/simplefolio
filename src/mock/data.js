...
export const aboutData = {
  img: 'profile.jpg',
  paragraphOne:
    'Software specializing in both frontend and backend development. Experienced with nearly all stages of the development cycle for dynamic web projects. Well-versed in numerous programming languages including JavaScript, React, Node, Express, HTML5, CSS, PHP, Python, Java, MySQL, PostgreSQL, MongoDB, Redis, RabbitMQ. Have a good background in Computer Science.',
  paragraphTwo:
